        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 md:gap-x-6 w-full">
          ...
          <div className="md:col-span-2">
            <input
              ...
              className={`bg-transparent border border-primary rounded-md px-4 py-2 w-full text-white placeholder:text-grayDescription focus:outline-none focus:border-[2px] ${
