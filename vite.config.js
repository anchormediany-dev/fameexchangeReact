    ...
    rollupOptions: {
      ...
      output: {
        ...
        manualChunks(id) {
          ...
          // Keep React core in the same chunk as react-dom / react-router so
          // dependent chunks can never load before React is initialized
          // (otherwise the production bundle throws "React is not defined").
          if (
